  ...
  return (
    <ModalWrapper>
      <div
        ...
        className={`${
          show ? '' : 'hidden'
        } bg-[#2f2f2f] bg-opacity-40 overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%)] max-h-full`}
      >
